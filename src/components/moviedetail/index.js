...
class MovieDetail extends Component {
  ...
  componentWillMount() {
    ...
    fetch(`https://www.omdbapi.com/?apikey=fa9a7315&i=${this.state.movieId}`)
      .then((res) => res.json())
      .then((data) => {
                ...
                <div className="col-md-8 col-sm-6 col-xs-12">
                  <div>
                    <div className="row">
                      ...
                      <div className="col-xs-12">
                        <h3>Language : {state.movie.Language}</h3>
                      </div>
                      <div className="col-xs-12">
                        <h3>Genre : {state.movie.Genre}</h3>
                      </div>
                      <div className="col-xs-12">
                        <h3>Released : {state.movie.Released}</h3>
                      </div>
                      <div className="col-xs-12">
                        <h3>Actors : {state.movie.Actors}</h3>
                      </div>
                    </div>
